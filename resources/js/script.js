(function ($) {
    $(document).ready(function (e) {
        ...
        function validate(element, form) {
            ...
            switch (
                ...
                case "email": // Case email
                    var emailRegex =
                        /^[-\w.%+]{1,64}@(?:[A-Z0-9-]{1,63}\.){1,125}[A-Z]{2,63}$/i; // Regex to validate email
                ...
                if (result.isConfirmed && action) {
                    $.ajax({
                        ...
                        beforeSend: function () {
                            // Before send request
                            showWaitMe(
                                "Suppression des informations, veuillez patienter...",
                                "facebook"
                            );
                        },
        ...
        $("[data-change-menu]").on("change", function () {
            var data = {
                // Saving parameters to the function in the controller
        ...
        $("[data-open-menu]").on("click", function (e) {
            // Listener to open / hide menu only mobile
            ...
            $("[data-wrapper='" + wrapper + "']").toggleClass(
                "wrapper__container--small"
            ); // To wrapper add / remove class wrapper__container--small
            $(".header__logo").toggleClass("header__logo--full"); // To header__logo add / remove class header__logo--full
            if ($("[data-table]").length) {
                // If attribute data table exists
                setTimeout(function (e) {
                    $("[data-table]")
                        .DataTable()
                        .columns.adjust()
                        .responsive.recalc(); // Adjust the responsive of columns of all tables
                }, 600);
            }
            actionsResize();
        });
        ...
        if ($("#calendar").length) {
            ...
            $.ajax({
                ...
                beforeSend: function () {
                    showWaitMe(
                        "Préparation du calendrier, veuillez patienter ...",
                        "facebook"
                    );
                },
                success: function (response) {
                    ...
                    if (response.status) {
                        ...
                        for (var i in emails) {
                            $("#colors-users-calendar").append(
                                '<span class="color-user-calendar" style="background:#' +
                                    i +
                                    '"></span> ' +
                                    emails[i] +
                                    ' <input type="checkbox" data-hide-calendar="' +
                                    emails[i] +
                                    '" class="check-middle" value="true"></br>'
                            );
                        }
                        ...
                        $("[data-hide-calendar]").on("click", function () {
                            // To hide ow show events of each calendar
                            if ($(this).prop("checked")) {
                                ...
                                var name = "admin@maisonsvides.be";
                                var classn = name
                                    .replaceAll("@", "-")
                                    .replaceAll(".", "-");
                                $("." + classn).show();
            ...
            $("#calendarModal").on("show.bs.modal", function (e) {
                // Listener when the modal is open
                ...
                if (
                    ...
                    information.coordinates.lat
                ) {
                    var srcMap =
                        "https://maps.google.com/maps?q=+" +
                        information.coordinates.lat +
                        "+,+" +
                        information.coordinates.long +
                        "+&hl=es&z=14&output=embed&hl=fr";
                } // URL of the estate
                else {
                    var srcMap =
                        "https://maps.google.com/maps?q=mi+ubicacion&hl=es&z=14&output=embed&hl=fr";
                }
        ...
        $("#calendargoogle").on("show.bs.modal", function (e) {
            ...
            $.ajax({
                ...
                beforeSend: function () {
                    ...
                    showWaitMe(
                        "Préparation du calendrier, veuillez patienter 2 ...",
                        "facebook"
                    );
                },
                success: function (response) {
            ...
            $("#calendarModal").on("show.bs.modal", function (e) {
                ...
                var srcMap =
                    ...
                    "+,+" +
                    information.coordinates.long +
                    "+&hl=es&z=14&output=embed&hl=fr"; // URL of the estate
                $("[data-coordinates]").attr("src", srcMap); // Set the url on the iframe of map
            });
        });
        ...
        if ($("[data-table]").length) {
            // If data-table attribute exists
            var search = "";
            ...
            var paramentersDataTable = {
                ...
                language: {
                    ...
                    sInfoEmpty:
                        "Affichage des enregistrements de 0 à 0 sur un total de 0 enregistrements", // Number of register showing
                    sInfoFiltered:
                        "(filtrage d'un total de _MAX_ enregistrements)", // Number of registers on filter
                    sInfoPostFix: "",
                    ...
                    oAria: {
                        sSortAscending:
                            ": Activé pour trier la colonne par ordre croissant", // Active sort ascending
                        sSortDescending:
                            ":r Activer pour trier la colonne par ordre décroissant", // Active short descending
                    },
                    buttons: {
                        copy: "Copier", // Copy
            ...
            $("a[data-toggle='tab']").on("shown.bs.tab", function (e) {
                ...
                $(tabContent)
                    .find("[data-table]")
                    .DataTable(paramentersDataTable); // Reinit the table
                if (!$(tabContent).find(".active.show").length) {
                    // If the tab has not classes active and show
                    $(tabContent).find("a[data-toggle='tab']").first().click(); // Click on first sub tab
                }
            });
        }
        $("[data-href]").on("click", function (e) {
            // Listener to smooth scroll
            ...
            $("html, body").animate(
                {
                    scrollTop:
                        ...
                        $("header").first().height() -
                        50, // Scrolling to element
                },
                600
            );
        });
        function actionsResize() {
            // Anctios to run on resize window
            $("body").attr("data-offset", $("header").first().height() + 55); // Change de offset in body to scrollspy
            if ($("#menu-scrolling").length) {
                // If the menu of anchors estates exists
                if ($(window).width() >= 992) {
                    // If the window width is bigger that 992
                    setTimeout(function () {
                        var top =
                            ($("header").first().height() -
                                $("#menu-scrolling").outerHeight()) /
                            2; // Get the size of header less the menu estate height between 2
                        $("#menu-scrolling").css({ top: "" }); // Set the top empty
                        $("#menu-scrolling").css({ top: top + "px" }); // Set the menu in the middle
                    }, 600);
                }
                if ($("[data-menu='menu'").hasClass("menu--opened")) {
                    // If general menu has the menu--opened
                    $("#menu-scrolling").addClass("wrapper__anchors--minified"); // Add class wrapper__anchors--minified
                } else {
                    $("#menu-scrolling").removeClass(
                        "wrapper__anchors--minified"
                    ); // Remove class wrapper__anchors--minified
                }
            }
        }
        ...
        $("[data-edit-form]").on("click", function (e) {
            // Listener in button to edit form
            e.preventDefault(); // Prevent default
        ...
        $("[data-cancel-form]").on("click", function (e) {
            // Listener in button to cancel form
            e.preventDefault(); // Prevent default
        ...
        $(document).on("click", "[data-submit-form]", function (e) {
            // Listener in button to submit form
            e.preventDefault(); // Prevent default
            isModify = false;
            ...
            var form = document.querySelector("[data-form='" + nameForm + "']"); // Get form
            var hide =
                $(this).attr("data-submit-hide") === "true" ? true : false; // Hide button true or false
            ...
            var clean =
                $(form).attr("data-clean") &&
                $(form).attr("data-clean") === "true"
                    ? true
                    : false; // Get clean form
            var reload =
                $(form).attr("data-reload") &&
                $(form).attr("data-reload") === "true"
                    ? true
                    : false; // Get reload page
            var ajax =
                $(form).attr("data-ajax") &&
                $(form).attr("data-ajax") === "false"
                    ? false
                    : true; // Get reload page
            if (!ajax) {
                $(form).submit();
            } else {
                $(form)
                    ...
                    .not("[type='hidden']")
                    .each(function (event) {
                        // Check all select, input, textarea that are required
                        if (validate(this, form)) {
                            // If prevent submit is true
                ...
                if (!preventSubmitt) {
                    ...
                    $.ajax({
                        ...
                        beforeSend: function () {
                            // Before send request
                            showWaitMe(
                                "Mise à jour des informations, veuillez patienter...",
                                "facebook"
                            );
                        },
                        success: function (response) {
                            ...
                            if ($("[data-modified='true']").length) {
                                isModify = true;
                                addEventListener("beforeunload", checkforms, {
                                    capture: true,
                                });
                            }
                            if (response.status) {
                                if (hide) {
                                    ...
                                    $(form)
                                        ...
                                        .prop("disabled", true); // Disable input, textarea, select
                                    $(
                                        "[data-submit-form='" + nameForm + "']"
                                    ).hide(); // Hide the button submit
                                }
                                $("[data-edit-form='" + nameForm + "']").show(); // Show the button edit
                                $(
                                    "[data-cancel-form='" + nameForm + "']"
                                ).hide(); // Hide the button cancel
                            ...
                            if (!response.status) {
                                // If status of response is false
                                showSwal(
                                    "Erreur",
                                    response.message,
                                    "error",
        ...
        $("[data-password]").on("click", function (e) {
            // Listener to change password by text
            e.preventDefault(); // Prevent default
            ...
            var nextType =
                inputPassword.attr("type") === "password" ? "text" : "password"; // Save the next type of input
        ...
        if ($("#estate_template_sms").length) {
            var idTemplateSMS = document.getElementById(
                "estate_template_sms"
            ).value;
        ...
        if ($("#estate_template_email").length) {
            var idTemplateEmail = document.getElementById(
                "estate_template_email"
            ).value;
        ...
        function readImage(file, max, container, type) {
            // Function to readImage or documents to upload
            ...
            function readFile(index) {
                ...
                if (index >= max) {
                    ...
                    fr.onload = function (e) {
                        ...
                        html +=
                            '<a data-delete data-temp="' + uid + '" href="">';
                        ...
                        if (type === "photos") {
                            // If type is photos
                            var indexIndicator = $(
                                "#carouselEstatePhotos"
                            ).find(".carousel-indicators > li").length
                                ? parseInt(
                                      $("#carouselEstatePhotos")
                                ...
                                : 0; // Get the last indicator and plus one
                            var indicator =
                                '<li data-target="#carouselEstatePhotos" data-slide-to="' +
                                indexIndicator +
                                '" class=""></li>';
                            var classActive =
                                indexIndicator === 0 ? " active" : "";
                            var slide =
                            ...
                            $("#carouselEstatePhotos")
                                ...
                                .append(indicator); // Append the new indicator to carousel
                            $("#carouselEstatePhotos")
                                .find(".carousel-inner")
                                .append(slide); // Append the new slide to carousel
                            if (indexIndicator >= 1) {
                                $("#carouselEstatePhotos")
                        ...
                        $.ajax({
                            // Function ajax so save file in sdk and db
                            ...
                            success: function (response) {
                                if (
                                    typeof response.uid !== typeof undefined &&
                                    response.uid !== false
                                ) {
                                    var urlmedia = urldeletemedias.replace(
                                        "/0",
                                        ""
                                    );
                                    $(
                                        "[data-temp='" + response.uid + "']"
                                    ).attr(
                                        "href",
                                        urlmedia + "/" + response.id
                                    );
                                }
        ...
        $("[data-files]").on("change", function (e) {
            // Listener in input files for photos and documents
            ...
            if (max) {
                // If max is different of 0
                if (typeFiles === "photos") {
                    // If typeFiles is equal to photos
                    text =
                        "Type de fichier invalide. Seuls les jpeg, jpg, png sont autorisés"; // Text to show in the popup
                    for (var i = 0; i < max; i++) {
                        if (
                            fileTypesPhotos.indexOf(
                                file.files[i].type.split("/")[1]
                            ) >= 0
                        ) {
                ...
                if (typeFiles === "documents") {
                    // If type is equal to documents
                    text =
                        "Type de fichier invalide. Seuls les pdf, json sont autorisés"; // Text to show in the popup
                    for (var i = 0; i < max; i++) {
                        if (
                            fileTypesDocuments.indexOf(
                                file.files[i].type.split("/")[1]
                            ) >= 0
                        ) {
                            // If extensions are allowed
                ...
                if (correctFiles) {
                    // If correct files is true
                    showWaitMe(
                        "Préparation de(s) fichier(s), veuillez patienter ...",
                        "facebook"
                    );
        ...
        function changePhoto(file, container) {
            // Function to change main photo
            var fr = new FileReader(); // Create a new instance of File Reader
            fr.onload = function (e) {
                // Function onload
                $("[data-img-view='" + container + "']").attr(
                    "src",
                    e.target.result
        ...
        $("[data-image]").on("change", function (e) {
            // Listener input to change image
            var file = this; // Save the current input file
            if (file.files.length) {
                var container = $(this).attr("data-image"); // Save the container
                if (
                    fileTypesPhotos.indexOf(file.files[0].type.split("/")[1]) >=
                    0
                ) {
                    // If the extentions are allowed
                    showWaitMe(
                        "Changement de photo, veuillez patienter ...",
                        "facebook"
                    );
                    ...
                    showSwal(
                        "Erreur",
                        "Type de fichier invalide. Seuls les jpeg, jpg, png sont autorisés",
                        "error",
                        false,
                        false
                    );
        ...
        $("[data-template]").on("click", function (e) {
            // Listener click on create template
        ...
        $("#template_c").on("change", function () {
            // Listener when select change
            ...
            $("#edit_template").attr(
                "data-target",
                "#editTemplate-" + idTemplate
            ); // Add atribute data to the modal of edit the template
        ...
        if ($("[data-tiny]").length) {
            // If attribute data-tiny exists
            $("[data-tiny]").each(function (e) {
                // For each data-tiny
                    ...
                    setup: function (editor) {
                        ...
                        var remarks =
                            "<table>\
										<tr>\
											...
											<td>" +
                            $("[name='interior_state']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Etat maison - Extérieur: </td>\
											<td>" +
                            $("[name='exterior_state']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Etat maison - Le quartier: </td>\
											<td>" +
                            $("[name='district_state']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Points forts - Intérieur: </td>\
											<td>" +
                            $("[name='interior_highlights']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Points forts - Extérieur: </td>\
											<td>" +
                            $("[name='exterior_highlights']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Points faibles - Intérieur: </td>\
											<td>" +
                            $("[name='interior_weak_point']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Points faibles - Extérieur: </td>\
											<td>" +
                            $("[name='exterior_weak_point']").val() +
                            "</td>\
										</tr>\
									</table>";
                        var bieninterior =
                            "<table>\
										<tr>\
											<td>Chambres: </td>\
											<td>" +
                            $("[name='rooms_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Chambres - étage: </td>\
											<td>" +
                            $("[name='floorRooms_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Sdb: </td>\
											<td>" +
                            $("[name='floorBathroom_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Sdb -	- étage: </td>\
											<td>" +
                            $("[name='surfaceHabitable_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Surf.Habitable: </td>\
											<td>" +
                            $("[name='floors_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Etages: </td>\
											<td>" +
                            $("[name='estimDecoration_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Estim. décoration: </td>\
											<td>" +
                            $("[name='soilType_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Type de sol - Living: </td>\
											<td>" +
                            $("[name='typeOfLivingFloor_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Type de sol - Chambres: </td>\
											<td>" +
                            $("[name='typeOfLivingRooms_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Cuisine: </td>\
											<td>" +
                            $("[name='kitchen_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Cuisine - Type: </td>\
											<td>" +
                            $("[name='typeOfKitchen_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Cuisine - Plan travail: </td>\
											<td>" +
                            $("[name='worktopKitchen_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Cuisine - Age: </td>\
											<td>" +
                            $("[name='ageKitchen_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Cuisine - Etat: </td>\
											<td>" +
                            $("[name='stateKitchen_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Etat général: </td>\
											<td>" +
                            $("[name='stateGeneral_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Typ.Chauff. centr.: </td>\
											<td>" +
                            $("[name='chassisCentralType_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Typ.Châssis: </td>\
											<td>" +
                            $("[name='chassisType_adapte']").val() +
                            "</td>\
										</tr>\
									</table>";
                        var bienexterior =
                            "<table>\
										<tr>\
											...
											<td>" +
                            $("[name='jardinOrientation_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Jardin - surface: </td>\
											<td>" +
                            $("[name='jardinArea_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Terrasse: </td>\
											<td>" +
                            $("[name='terrace_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Balcon: </td>\
											<td>" +
                            $("[name='balcony_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Véranda: </td>\
											<td>" +
                            $("[name='veranda_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Panneaux solaires: </td>\
											<td>" +
                            $("[name='solarPanels_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Panneaux solaires - Installés le: </td>\
											<td>" +
                            $("[name='solarPanelInstaldDate_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Etat général: </td>\
											<td>" +
                            $("[name='stateGeneralExterior_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Parking: </td>\
											<td>" +
                            $("[name='parking_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Parking	- Combien de place(s): </td>\
											<td>" +
                            $("[name='parkingHowManyPlaces_adapte']").val() +
                            "</td>\
										</tr>\
										<tr>\
											<td>Parking - Type(s): </td>\
											<td>" +
                            $("[name='typeParking_adapte']").val() +
                            "</td>\
										</tr>\
									</table>";
                        editor.on("init", function () {
                            ...
                            if (id == "tinyEditOffer") {
                                ...
                                content = content.replace(
                                    "[description-estate]",
                                    $("[name='estate_description']").val()
                                );
                                content = content.replace(
                                    "[details-interior-estate]",
                                    bieninterior
                                );
                                content = content.replace(
                                    "[details-exterior-estate]",
                                    bienexterior
                                );
                                content = content.replace(
                                    "[remarks-estate]",
        ...
        if ($("#setVisit").length) {
            ...
            var visitDatePicker = datepicker("#visitDate", {
                ...
                onSelect: function (instance, date) {
                    ...
                    $("[data-form='" + formVisit + "']")
                        .find("input[name='date_visit']")
                        .val(visit); // Set the value in the input to date
                    $("[data-form='" + formVisit + "']")
                        .find("[data-date]")
                        .text(value); // Set the valie in the text
                },
            });
            $("#setVisit").on("show.bs.modal", function (e) {
                // Listerner when the popup to set the visit
            ...
            $("#visitStart").timepicker({
                // Init the timepicker to start
            ...
            $("#visitEnd").timepicker({
                // Init the timepicker to end
                timeFormat: "H:i:s", // Time format
                step: 15, // Step
                minTime: "06:00am",
                maxTime: "08:00pm",
            });
            $("#visitStart").on("change", function (e) {
                // Listener when the value on input change
                var value = $(this).val(); // Get value
                if (value !== "") {
                    // If value isn't empty
                    $("[data-form='" + formVisit + "']")
                        .find("input[name='date_start']")
                        .val(value); // Set the value on input start
                    $("[data-form='" + formVisit + "']")
                        .find("[data-start]")
                        .text(value); // Set the value text start
                }
            });
            $("#visitEnd").on("change", function (e) {
                // Listener when the value on input change
                var value = $(this).val(); // Get value
                if (value !== "") {
                    // If value isn't empty
                    $("[data-form='" + formVisit + "']")
                        .find("input[name='date_end']")
                        .val(value); // Set the value on input start
                    $("[data-form='" + formVisit + "']")
                        .find("[data-end]")
                        .text(value); // Set the value text start
            ...
            $("[data-register-visit]").on("click", function (e) {
                // Listener to add event of visit
                e.preventDefault(); // Prevent default
                ...
                var date = $("[data-form='" + dataForm + "']")
                    .find("input[name='date_visit']")
                    .val(); // Get the date
                var start = $("[data-form='" + dataForm + "']")
                    .find("input[name='date_start']")
                    .val(); // Get the start
                var end = $("[data-form='" + dataForm + "']")
                    .find("input[name='date_end']")
                    .val(); // Get the end
                if (date !== "" && start !== "" && end !== "") {
                    ...
                    $.ajax({
                        ...
                        beforeSend: function () {
                            ...
                            showWaitMe(
                                "Inscription à la visite, veuillez patienter ...",
                                "facebook"
                            ); // Show waitMe popup
                        },
                        success: function (response) {
                    ...
                    showSwal(
                        "Erreur",
                        "Vérifier les données de visite (date, heure de début et de fin)",
                        "error",
                        false,
                        false
                    ); // Show swal popup with the error of data is empty
                }
            });
        }
        $("#editUser").on("show.bs.modal", function (e) {
            ...
            modal
                .find("select[name='type'] option[value='" + aUser.type + "']")
                .prop("selected", true);
            ...
            if ($("#typeUser").val() == 2 || $("#typeUser").val() == 1) {
                // If is a manager (secretary)
                $("[data-ed-us]").show();
            } else {
                $("[data-ed-us]").hide();
            }
        ...
        function slug(str) {
            // Function to convert the category name in slug
        ...
        $("[data-category]").on("keyup", function () {
            // Listener when write the category name
        ...
        $("#editCategory").on("show.bs.modal", function (e) {
            var modal = $(this);
            var relatedTarget = e.relatedTarget;
            var idCategory = parseInt(
                $(e.relatedTarget).attr("data-category-id")
            );
            var aCategory = null;
            ...
            modal
                .find(
                    "select[name='parent'] option[value='" +
                        aCategory.parent +
                        "']"
                )
                .prop("selected", true);
                ...
                var localisation =
                    "<table>\
									<tr>\
										<td>Rue: </td>\
										<td>" +
                    $("[name='estate__street']").val() +
                    "</td>\
									</tr>\
									<tr>\
										<td>N°:</td>\
										<td>" +
                    $("[name='estate__number']").val() +
                    "</td>\
									</tr>\
									<tr>\
										<td>Bt:</td>\
										<td>" +
                    $("[name='estate__box']").val() +
                    "</td>\
									</tr>\
									<tr>\
										<td>CP:</td>\
										<td>" +
                    $("[name='estate__code_postal']").val() +
                    "</td>\
									</tr>\
									<tr>\
										<td>Ville:</td>\
										<td>" +
                    $("[name='estate__city']").val() +
                    "</td>\
									</tr>\
								</table>";
                // Save data
                ...
                var requereur =
                    ...
                    "</td>\
									...
									<tr>\
										<td>Tel:</td>\
										<td>" +
                    $("[name='seller_phone']").val() +
                    "</td>\
									</tr>\
									<tr>\
										<td>Mail: </td>\
										<td>" +
                    $("[name='seller_email']").val() +
                    "</td>\
									</tr>\
								</table>";
                // Save data
                ...
                var cherche =
                    "<table>\
									<tr>\
										...
										<td>" +
                    $("[name='seller_looking_property']").val() +
                    "</td>\
									</tr>\
									<tr>\
										<td>Désire rester locataire ?: </td>\
										<td>" +
                    $("[name='seller_want_stay_tenant']").val() +
                    "</td>\
									</tr>\
									<tr>\
										<td>Quand procéder à l’achat ?: </td>\
										<td>" +
                    $("[name='seller_when_to_buy']").val() +
                    "</td>\
									</tr>\
									<tr>\
										<td>Information complémentaire: </td>\
										<td>" +
                    $("[name='estate__information_additional']").val() +
                    "</td>\
									</tr>\
								</table>";
                // Save data
                ...
                var problemes =
                    "<table>\
										<tr>\
											...
											<td>" +
                    $("[name='estate_problem_signal']").val() +
                    "</td>\
										</tr>\
										<tr>\
											<td>Suivi résolution: </td>\
											<td>" +
                    $("[name='estate_new_problem']").val() +
                    "</td>\
										</tr>\
									</table>";
                // Save data
        ...
        var offer =
            "<table>\
						<tr>\
							...
							<td>" +
            $("[name='price_wesold']").val() +
            "</td>\
						</tr>\
						<tr>\
							<td>Texte à ajouter à l’offre: </td>\
							<td>" +
            $("[name='other_offer']").val() +
            "</td>\
						</tr>\
					</table>";
        $("#inf_offer").val(offer);
        ...
        $("[data-save-data]").on("click", function () {
            ...
            validateoffer =
                ("0" + validateoffer.getDate()).slice(-2) +
                " " +
                months[validateoffer.getMonth() + 1] +
                " " +
                validateoffer.getFullYear();
            ...
            if (dataNotary === "") {
                newBody = newBody.replace(
                    "<li>Notaire de l&rsquo;acqu&eacute;reur : [notary]</li>",
                    ""
                );
            } else {
            ...
            newBody = newBody.replace(
                "[price-letter]",
                writtenNumber(pricewesold, { lang: "fr" }).toUpperCase()
            );
        ...
        $("#text_add_email_offer").on("change", function () {
            ...
            var dataCorps = document.getElementById(
                "text_add_email_offer"
            ).value;
        ...
        $("[data-send-form]").on("click", function () {
            // When click send link in the main form
				...
				<div id="' +
					...
					<div class="row">\
						...
						<div class="col-xs-12 col-sm-12 col-md-10 col-lg-12 col-xl-10">\
							<select name="type_rappel[]" data-template="' +
                    n +
                    '" id="type_rappel_' +
                    n +
                    '" class="form-control">\
					...
					<div class="row">\
						...
						<div class="col-xs-12 col-sm-12 col-md-10 col-lg-12 col-xl-10">\
							<select name="type_rappel_choised[]" class="form-control" id="rappel_email_' +
                    n +
                    '">' +
                    optionsTemplateEmail +
                    '</select>\
							<select name="type_rappel_choised[]" class="form-control" id="rappel_sms_' +
                    n +
                    '">' +
                    optionsTemplateSMS +
                    '</select>\
							<select name="type_rappel_choised[]" class="form-control" id="rappel_task_' +
                    n +
                    '">' +
                    optionsTemplateTask +
                    '</select>\
                    ...
                    n +
                    '" class="btn btn-danger">Supprimer ce rappel</button>\
					</div>\
				</div>\
			'
            );
        ...
        $(document).on("change", "[data-template]", function () {
            ...
            if ($(this).val() == "email") {
                // If value of the option is email
            ...
            if ($(this).val() == "task") {
                // If value of the option is task
                console.log("is task");
                $("#rappel_email_" + id).hide(); // Hide templates of email
                $("#rappel_sms_" + id).hide(); // Hide templates of sms
        ...
        if ($("#date_manual").length) {
            // If exist id 'date_manual'
        ...
        $("#change_date_two").on("click", function () {
            // When click on checkbox
        ...
        $("#addReminderWPC").on("click", function () {
            ...
            $("#remindersadded").append(
                '<div class="withoutProcessCharged" id="' +
                    n +
                    '">\
						<div class="row mb-2">\
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">\
						...
						<div class="row mb-2">\
							...
							<div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-xl-9">\
								<select name="type_rappel[]" data-disabled-add-reminder="withoutProcessCharged" data-type-template-d="' +
                    n +
                    '" data-template="' +
                    n +
                    '" id="type_rappel_' +
                    ...
                    '" class="form-control">\
						...
						<div class="row mb-2">\
							...
							<div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-xl-9">\
								<select name="type_rappel_choised[]" data-name-reminder="' +
                    n +
                    '" class="form-control" id="rappel_email_' +
                    n +
                    '">' +
                    optionsTemplateEmail +
                    '</select>\
								<select name="type_rappel_choised[]" data-name-reminder="' +
                    n +
                    '" class="form-control" id="rappel_sms_' +
                    n +
                    '">' +
                    optionsTemplateSMS +
                    '</select>\
								<select name="type_rappel_choised[]" data-name-reminder="' +
                    n +
                    '" class="form-control" id="rappel_task_' +
                    n +
                    '">' +
                    optionsTemplateTask +
                    '</select>\
						...
						<div class="row mb-2" id="subject_template_d_' +
                    n +
                    '">\
							<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-3">\
						...
						<div class="row mb-2">\
							...
							<div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-xl-9">\
								<textarea id="contenu-d-' +
                    n +
                    '" data-contenu-reminder="' +
                    n +
                    '" class="form-control" name="content_reminder[]" rows="4"></textarea>\
							</div>\
						</div>\
						<div class="row mb-2">\
							...
							<div class="text-left col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-7">\
								<button type="button" class="btn btn-danger" data-id-delete="' +
                    n +
                    '">Supprimer ce rappel</button>\
							</div>\
						</div>\
					</div>'
            );
        ...
        $(document).on("change", "[data-disabled-add-reminder]", function () {
            ...
            var isfirst =
                $(this).parents(".withoutProcessCharged").attr("id") &&
                $(this).parents(".withoutProcessCharged").attr("id") ===
                    "firsth"
                    ? true
                    : false;
            if ($(this).val() === "task") {
                ...
                $(this)
                    .parents(".withoutProcessCharged")
                    .nextAll(".withoutProcessCharged")
                    .remove();
                $("#remindersadded").find(".withoutProcessCharged").remove();
                if (container === "withProcessCharged") {
                    $("#remindersadded")
                        .find(".withoutProcessCharged")
                        .remove();
                    $(this)
                        .parents(".withProcessCharged")
                        .nextAll(".withProcessCharged")
                        .remove();
                }
                if (isfirst) {
                    $("#remindersadded")
        ...
        if ($("#file_template_name_create").length) {
            ...
            aTemplates.forEach(function (template) {
                if (val == template.file) {
                    ...
                    $("#auxSubject").append(
                        '<input type="hidden" name="subject_template_reminder" value="' +
                            template.subject +
                            '">'
                    );
                }
            ...
            aTemplatesReminders.forEach(function (reminders) {
                if (reminders.id == val) {
                    ...
                    rem.forEach(function (remin) {
                        var selectedemail =
                            remin.type_template === "email" ? "selected" : "";
                        var selectedsms =
                            remin.type_template === "sms" ? "selected" : "";
                        var selectedtask =
                            remin.type_template === "task" ? "selected" : "";
                        var displayemail =
                            remin.type_template === "email"
                                ? "data-call-click"
                                : 'style="display: none;"';
                        var displaysms =
                            remin.type_template === "sms"
                                ? "data-call-click"
                                : 'style="display: none;"';
                        var displaytask =
                            remin.type_template === "task"
                                ? "data-call-click"
                                : 'style="display: none;"';
                        var subje =
                            '<div class="row mb-2">\
                        ...
                        if (remin.position + 1 != 1) {
                            inputdays =
                                '<div class="row mb-2">\
										...
										<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-2">\
											<input type="number" name="days_reminder[]" value="' +
                                remin.days +
                                '" class="form-control">\
										</div>\
										<div class="text-left col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-7">\
                        ...
                        allReminders +=
                            '<div class="withProcessCharged" id="' +
                            remin.position +
                            '">\
									<div class="row mb-2">\
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">\
                            ...
                            '\
									...
									<div class="row mb-2">\
										...
										<div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-xl-9">\
											<select name="type_rappel[]" data-disabled-add-reminder="withProcessCharged" data-template="' +
                            remin.position +
                            '" id="type_rappel_' +
                            remin.position +
                            '" class="form-control">\
                            ...
                            '</select>\
									...
									<div class="row mb-2">\
										...
										<div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-xl-9">\
											<textarea class="form-control" data-contenu-reminder="' +
                            remin.position +
                            '" name="content_reminder[]" rows="4"></textarea>\
										</div>\
									</div>' +
                            subje +
                            inputdays +
        ...
        $("#charge_process").on("click", function () {
            // When click on checkbox
        ...
        $("#charge_process_task").on("click", function () {
            // When click on checkbox
        ...
        $("#add-point-strong-interior").on("click", function () {
            $("#strong-points-i").append(
                '<input type="text" name="interior_highlights[]" class="form-control mb-2" disabled value="">'
            );
        });
        // Add new strong point exterior
        $("#add-point-strong-exterior").on("click", function () {
            $("#strong-points-e").append(
                '<input type="text" name="exterior_highlights[]" class="form-control mb-2" disabled value="">'
            );
        });
        // Add new weak point exterior
        $("#add-point-weak-interior").on("click", function () {
            $("#weak-points-i").append(
                '<input type="text" name="interior_weak_point[]" class="form-control mb-2" disabled value="">'
            );
        });
        // Add new weak point exterior
        $("#add-point-weak-exterior").on("click", function () {
            $("#weak-points-e").append(
                '<input type="text" name="exterior_weak_point[]" class="form-control mb-2" disabled value="">'
            );
        });
        function getQueryVariable(variable) {
            //function to get variable of url
        ...
        if (getQueryVariable("modal") == "true") {
            // If variable modal exists and its true
        ...
        $("#nom_template").on("change", function () {
            ...
            var date =
                ...
                $("#date_confirm").val() +
                " De " +
                $("#date_confirm_start").val() +
                " à " +
                $("#date_confirm_end").val() +
                "</span>";
        ...
        $("[data-confirm-email]").on("click", function () {
            ...
            $("#modal_modal_date_confirm_end").val(
                $("#date_confirm_end").val()
            );
        });
        $("[data-confirm-sms]").on("click", function () {
            ...
            $("#modal_date_confirm_start_sms").val(
                $("#date_confirm_start").val()
            );
            $("#modal_modal_date_confirm_end_sms").val(
                $("#date_confirm_end").val()
            );
        });
        ...
        $(".add-newreminder-edit").on("click", function () {
            ...
            $(".add-reminder-edit").append(
				...
				<div id="' +
					...
					<div class="mb-4">\
						<button type="button" class="btn btn-danger" data-id-del="' +
                    n +
                    '">Supprimer ce rappel</button>\
					</div>\
				</div>'
        ...
        $(document).on("click", "[data-id-del]", function (e) {
            ...
            $(
                "[data-id-reminder='" + $(this).attr("data-id-del") + "']"
            ).remove();
        });
        ...
        $("#date_special").on("change", function () {
            ...
            var dateComplete =
                dateSplit[2] + " " + months[parseInt(dateSplit[1]) - 1];
            $("#dates_added").append(
                '<li id="' +
                    dateSplit[2] +
                    "-" +
        ...
        if ($("#type_de_bien").length) {
            ...
            if (
                $("#type_de_bien").val() == "Maison" ||
                $("#type_de_bien_adapte").val() == "Maison"
            ) {
            ...
            if (
                $("#type_de_bien").val() == "Appartement" ||
                $("#type_de_bien_adapte").val() == "Appartement"
            ) {
            ...
            if (
                $("#type_de_bien").val() == "Immeuble de rapport" ||
                $("#type_de_bien_adapte").val() == "Immeuble de rapport"
            ) {
                $("#type-bien-maison").hide();
                $("#type-bien-appartement").hide();
            ...
            if (
                $("#type_de_bien").val() == "Autre" ||
                $("#type_de_bien_adapte").val() == "Autre"
            ) {
                $("#type-bien-maison").hide();
                $("#type-bien-appartement").hide();
                $("#type-bien-immeuble").hide();
        ...
        var checkforms = function (event) {
            ...
            $("[data-modified='true']").each(function () {
                ...
                parentCard
                    ...
                    .addClass("notsaved")
                    .append(
                        "<span>Enregistrez vos modifications<i class='bi bi-exclamation-triangle'></i></span>"
                    );
            });
            return (event.returnValue =
                "Aucune modification n'a été enregistrée! Voulez-vous les enregistrer?");
        };
        ...
        $("[data-change-input]").on("keyup", function () {
            ...
            $(this)
                .parents("form")
                .find("[data-modified-modal]")
                .attr("data-modified-modal", true)
                .show();
        ...
        $("[data-cancel]").on("click", function () {
            ...
            $(this)
                .parents("form")
                .find("[data-modified-modal]")
                .attr("data-modified-modal", false)
                .show();
            $("[data-modified]").hide();
            $("[data-modified-modal]").hide();
            $("[data-cancel]").hide();
            if (isModify) {
                removeEventListener("beforeunload", checkforms, {
                    capture: true,
                });
            }
            isModify = false;
        ...
        if (urlProfile.indexOf("?tab-name=settings-users") >= 0) {
            ...
            $('#tab-main .nav-link[href="#' + "settings-users" + '"]').tab(
                "show"
            );
