	                                ...
	                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-12 col-xl-6">
	                                    <div class="wrapper__content">
	                                        <div class="wrapper__files">
	                                            ...
	                                            <input data-files="photos" data-container-files="list-documents" type="file" data-upload="{!! route('uploadphoto', 'photos') !!}" data-estate-id="{!! $id !!}" name="estate_photos" accept=".jpg, .jpeg, .png" multiple onchange="previewFile(event)">
	                                        </div>
	                                    </div>
	                                    <div class="mt-2" id="imagePreview"></div>
	                                </div>
	...
	<script>
	    ...
	    document.addEventListener('DOMContentLoaded', function() {
	        document.querySelector('input[name="estate_photos"]').addEventListener('change', previewFile);
	    });
	</script>
	@endsection
