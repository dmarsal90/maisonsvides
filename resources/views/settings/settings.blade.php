        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-3">
                    <nav>
                        <ul class="nav nav-tabs" id="templatesTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#templates-text" id="templates-text-tab" data-toggle="tab" role="tab" aria-controls="templates-text" aria-selected="false">Texte de
                                    l'offre</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="autosize-s">
                            <table data-table="touts" class="display responsive nowrap" style="width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    $templateType = 'text-offer';
                                    @endphp

                                    @foreach ($templates as $template)
                                    @if ($template['type'] == $templateType)
                                    @if (($userType == 1) || ($userType == 2 && in_array($template['user_id'], $teamOfManager)) || ($userType == 3 && Auth::user()->name == $template['user']))
                                    <tr>
                                        <td class="text-center">
                                            <a href="" data-delete>
                                                <img src="{!! asset('img/icons/delete.svg') !!}" width="16">
                ...
                <div class="text-left mt-4">
                    <button type="button" id="createTbtn" class="btn btn-lg btn-success" data-submit-hide="false" data-toggle="modal" data-target="#createTemplate"> <!-- data-submit-form="form-edit-category"> -->
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="text-right mt-4">
                    <button type="button" class="btn btn-lg btn-success" data-toggle="modal" data-target="#newUser" id="creerUser">
                        Créer
                    </button>
                </div>
            </div>
    ...
    <div id="settings-notaries" class="tab-pane fade" role="tabpanel" aria-labelledby="settings-notaries-tab">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="text-right mt-4">
                    <button type="button" class="btn btn-lg btn-success" data-toggle="modal" data-target="#newNotary">Créer
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="autosize-s">
                    ...
                    <div class="text-right mt-4">
                        <button type="button" class="btn btn-lg btn-success" data-toggle="modal" data-target="#newCategory">Créer
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 mt-2">
                            <button type="submit" class="btn btn-success" data-submit-form="form-hollyday-date" {!! (Auth::user()->type != 1) ? 'disabled' : '' !!}>
                        ...
                        <div class="wrapper__content__date col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 mt-2 ml-3 mr-3">
                            ...
                            <ul id="dates_added">
                                ...
                                <li id="{!! $date['date_special'] !!}">{!! $dayj[0] !!} {!! $months[round($dayj[1]) - 1] !!}
                                    <svg data-delete-date="{!! (Auth::user()->type == 1) ? $attrib : '' !!}" class="minus-date" xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="0 0 16 16">
                                        <path d="M14 1a1 1 0 011 1v12a1 1 0 01-1 1H2a1 1 0 01-1-1V2a1 1 0 011-1zM2 0a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V2a2 2 0 00-2-2z" />
                                        <path d="M4 8a.5.5 0 01.5-.5h7a.5.5 0 010 1h-7A.5.5 0 014 8z" />
                                    </svg>
                                    <span><input type="hidden" name="dates[]" value="{!! $date['date_special'] !!}">
                                </li>
                                @endforeach
                            </ul>
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div align="center" class="col-xs-3 col-sm-4 col-md-3 col-lg-3 col-xl-3">
                            <label>
                                <input type="radio" data-change-menu name="menu" value="Menu déroulant" {!! ($typemenu=='Menu déroulant' ) ? 'checked' : '' !!}>
                                Menu déroulant
                            </label><br>
                            <label>
                                <input type="radio" data-change-menu name="menu" value="Menu individuel" {!! ($typemenu=='Menu individuel' ) ? 'checked' : '' !!}>
                                Menu individuel
                            </label><br>
                        </div>
...
@section('modals')
<div class="modal fade" id="createTemplate" tabindex="-1" role="dialog" aria-labelledby="createTemplateLabel" aria-hidden="true">
                        ...
                        <div class="card-body">
                            ...
                            <div id="temem">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-12 col-xl-2"><br>
                                        <button type="button" data-send-form="{!! route('sendemailtemplatetest') !!}" class="btn btn-lg btn-success" data-submit-form="form-edit-template">Tester
                                        </button>
                                    </div>
                                </div>
                            </div>
                            <div id="temsms">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-12 col-xl-2"><br>
                                        <button type="submit" data-send-form="{!! route('sendsmstemplatetest') !!}" class="btn btn-lg btn-success" data-submit-form="form-edit-template">Tester
                                        </button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-right">
                                ...
                                <button type="submit" class="btn btn-lg btn-success" data-submit-form="form-edit-template">Sauvegarder
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-right">
                                ...
                                <button type="submit" class="btn btn-lg btn-success" data-submit-form="form-edit-template-email-{!! $template['id'] !!}">
                                    Sauvegarder
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-right">
                                ...
                                <button type="submit" class="btn btn-lg btn-success" data-submit-form="form-edit-template-sms-{!! $template['id'] !!}">
                                    Sauvegarder
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-right">
                                ...
                                <button type="submit" class="btn btn-lg btn-success" data-submit-form="form-edit-template-task-{!! $template['id'] !!}">
                                    Sauvegarder
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-right">
                                ...
                                <button type="submit" class="btn btn-lg btn-success" data-submit-form="form-edit-condition-{!! $template['id'] !!}">
                                    Sauvegarder
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-right">
                                ...
                                <button type="submit" class="btn btn-lg btn-success" data-submit-form="form-edit-texte-offer-{!! $template['id'] !!}">
                                    Sauvegarder
                                </button>
                            </div>
                        </div>
                        ...
                        <form action="{!! route('edittemplates', $reminder['id']) !!}" method="POST"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php $reminderData = unserialize($reminder['reminder']); ?>
                                    @foreach($reminderData as $info)
...
<script>
    $(document).ready(function() {
        ...
        $('#createTbtn').click(function() {
            $('#createTemplate').modal('show');
        });
    });
    $(document).ready(function() {
        // Agregar el evento de clic al botón
        $('#creerUser').click(function() {
            $('#newUser').modal('show');
        });
    });
</script>
